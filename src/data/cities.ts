    ...
    sections: {
      see: {
        ...
        items: [
          ...
          { name: "Wall Street + 銅牛", desc: "金融區地標，摸蛋蛋祈求財源", time: "15min", coord: "Wall Street" },
          { name: "Trinity Church 三一教堂", desc: "紐約最古老教堂，免費參觀", time: "15min", coord: "Trinity Church" },
      ...
      eat: {
        ...
        items: [
          ...
          { name: "Champion Pizza", desc: "Nassau St 超便宜大片 pizza，downtown 必吃", must: true, price: "$", coord: "Champion Pizza" },
        ],
      },
      buy: {
        title: "🛍️ 買的 / 購物",
...
export const itinerary: ItineraryDay[] = [
  {
    ...
    hotel: "Hotel IVY Boston Common - Queen Room",
    hotelCoord: "Hotel IVY Boston Common",
    budget: [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "12:30-12:45", act: "Trinity Church 三一教堂拍照 (紐約最古老教堂，免費)", icon: "⛪", coord: "Trinity Church" },
      { time: "12:45-13:00", act: "Wall Street + Charging Bull 銅牛拍照 🐂", icon: "🐂", coord: "Wall Street" },
      { time: "13:00-13:15", act: "Champion Pizza 🍕 (Nassau St 外帶一片邊走邊吃)", icon: "🍕", coord: "Champion Pizza" },
      { time: "13:15", act: "The Oculus 展翅建築朝聖", icon: "🕊️", coord: "The Oculus" },
      {
        time: "13:30-14:30",
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "09:15-09:45", act: "🗼 Washington Monument 登頂！(依領取的時段入場)", icon: "🗼", coord: "Washington Monument" },
      {
        time: "10:00-12:00",
        act: "🚀 Air & Space Museum (已預約 10:00 AM 入場)",
        icon: "🚀",
        coord: "Air & Space Museum",
      },
      {
      ...
      {
        time: "14:30",
        act: "📚 Library of Congress 國會圖書館 (已預約 2:30 PM)",
        icon: "📚",
        coord: "Library of Congress",
      },
      {
        time: "15:30",
        act: "U.S. Capitol 國會大廈 (導覽參觀)",
        icon: "🏛️",
        coord: "U.S. Capitol",
      },
      {

...
export const itinerary: ItineraryDay[] = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "09:30-10:00", act: "走到 South Station", icon: "🚶", coord: "South Station" },
      { time: "10:30", act: "Amtrak → NYC Penn Station (~3.5hr)", icon: "🚆" },
      { time: "14:00", act: "抵達 NYC → check in Arlo NoMad", icon: "🏨", coord: "Arlo NoMad" },
      {
        time: "15:00-16:30",
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "15:30-16:00", act: "閒逛回飯店拿行李", icon: "🧳" },
